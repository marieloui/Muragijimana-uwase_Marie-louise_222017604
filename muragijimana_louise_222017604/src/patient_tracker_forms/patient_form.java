...
public class patient_form implements ActionListener {


JFrame frame;//PatientID;FirstName;LastName;Gender;PhoneNumber;
...
public void actionPerformed(ActionEvent e) {
	...
	p.setPatientID(PatientID_txf.getText());
	p.setFirstName(FirstName_txf.getText());
	p.setLastname(LastName_txf.getText());

	p.setGender(Gender_txf.getText());
	p.setPhoneNumber(PhoneNumber_txf.getText());
	...
	p.insertData();
			...
			DefaultTableModel tableModel=p.populateTable();
	...
	public static void main(String[] args) {
		...
		patient_form ptf=new patient_form();
